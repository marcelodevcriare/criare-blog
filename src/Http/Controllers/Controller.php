...
use Criarenet\Blog\Events\FileDeleted;
use Criarenet\Blog\Http\Controllers\ContentTypes\Checkbox;
use Criarenet\Blog\Http\Controllers\ContentTypes\Coordinates;
use Criarenet\Blog\Http\Controllers\ContentTypes\File;
use Criarenet\Blog\Http\Controllers\ContentTypes\Image as ContentImage;
use Criarenet\Blog\Http\Controllers\ContentTypes\MultipleCheckbox;
use Criarenet\Blog\Http\Controllers\ContentTypes\MultipleImage;
use Criarenet\Blog\Http\Controllers\ContentTypes\Password;
use Criarenet\Blog\Http\Controllers\ContentTypes\Relationship;
use Criarenet\Blog\Http\Controllers\ContentTypes\SelectMultiple;
use Criarenet\Blog\Http\Controllers\ContentTypes\Text;
use Criarenet\Blog\Http\Controllers\ContentTypes\Timestamp;
use Criarenet\Blog\Traits\AlertsMessages;
use Validator;
