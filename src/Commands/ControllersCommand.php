...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/criarenet/blog/src/Http/Controllers'));
        $namespace = config('voyager.controllers.namespace', 'Criarenet\\Blog\Http\\Controllers');
    ...
    {
        return $this->filesystem->get(base_path('/vendor/criarenet/blog/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Criarenet\\Blog\Http\\Controllers\\'.$class,
            $content
        );
