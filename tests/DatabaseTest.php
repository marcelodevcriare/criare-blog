...
use Criarenet\Tests\Database\Schema\SchemaManager;
use Criarenet\Tests\Database\Schema\Table;
use Criarenet\Tests\Database\Types\Type;
use Criarenet\Tests\Traits\AlertsMessages;
