...
use Criarenet\Blog\Events\FormFieldsRegistered;
use Criarenet\Blog\Facades\Voyager as VoyagerFacade;
use Criarenet\Blog\FormFields\After\DescriptionHandler;
use Criarenet\Blog\Http\Middleware\VoyagerAdminMiddleware;
use Criarenet\Blog\Models\MenuItem;
use Criarenet\Blog\Models\Setting;
use Criarenet\Blog\Policies\BasePolicy;
use Criarenet\Blog\Policies\MenuItemPolicy;
use Criarenet\Blog\Policies\SettingPolicy;
use Criarenet\Blog\Providers\VoyagerDummyServiceProvider;
use Criarenet\Blog\Providers\VoyagerEventServiceProvider;
use Criarenet\Blog\Seed;
use Criarenet\Blog\Translator\Collection as TranslatorCollection;
...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    protected function registerAlertComponents()
    {
        ...
        foreach ($components as $component) {
            $class = 'Criarenet\\Blog\Alert\\Components\\'.ucfirst(Str::camel($component)).'Component';
    ...
    protected function registerFormFields()
    {
        ...
        foreach ($formFields as $formField) {
            ...
            VoyagerFacade::addFormField("Criarenet\\Blog\FormFields\\{$class}");
        }
