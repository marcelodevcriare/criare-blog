...
use Criarenet\Blog\Actions\DeleteAction;
use Criarenet\Blog\Actions\EditAction;
use Criarenet\Blog\Actions\RestoreAction;
use Criarenet\Blog\Actions\ViewAction;
use Criarenet\Blog\Events\AlertsCollection;
use Criarenet\Blog\FormFields\After\HandlerInterface as AfterHandlerInterface;
use Criarenet\Blog\FormFields\HandlerInterface;
use Criarenet\Blog\Models\Category;
use Criarenet\Blog\Models\DataRow;
use Criarenet\Blog\Models\DataType;
use Criarenet\Blog\Models\Menu;
use Criarenet\Blog\Models\MenuItem;
use Criarenet\Blog\Models\Page;
use Criarenet\Blog\Models\Permission;
use Criarenet\Blog\Models\Post;
use Criarenet\Blog\Models\Role;
use Criarenet\Blog\Models\Setting;
use Criarenet\Blog\Models\Translation;
use Criarenet\Blog\Models\User;
use Criarenet\Blog\Traits\Translatable;
    ...
    protected function findVersion()
    {
        ...
        if ($this->filesystem->exists(base_path('composer.lock'))) {
            ...
            foreach ($file->packages as $package) {
                if ($package->name == 'criarenet/blog') {
