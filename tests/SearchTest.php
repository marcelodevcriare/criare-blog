...
use Criarenet\Tests\Http\Controllers\VoyagerBaseController;
use Criarenet\Tests\Models\DataRow;
use Criarenet\Tests\Models\DataType;
use Criarenet\Tests\Models\Post;
use Criarenet\Tests\Models\User;
...
class SearchTest extends TestCase
{
    ...
    protected function setupAuthorRelationship()
    {
        DataRow::create([
            ...
            'display_name' => 'Author',
            'details' => [
                'model' => 'Criarenet\Tests\Models\User',
                'table' => 'users',
                'type' => 'belongsTo',
                'column' => 'author_id',
                'key' => 'id',
