                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                @if(isset($dataTypeContent->avatar))
                                    <img src="{{ $dataTypeContent->avatar != 'users/default.png' ? Voyager::image($dataTypeContent->avatar) : url('/images/user_profile.png') }}" style="width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:10px;" />
                                @endif
